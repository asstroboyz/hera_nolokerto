...
<div class="container-fluid">
    ...
    <?php if (session()->getFlashdata('msg')): ?>
        <div class="row">
            <div class="col-12"><?=$this->extend('user/templates/index');?>
                ...
                <div class="card shadow px-5 py-4">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <img class="card-img-top p-2" src="<?=base_url();?>img/<?=user()->foto;?>" alt="Image profile" height="290">
                        </div>
...
echo (date_format($date, "d F Y H:i:s"))?></li>
                                <li class="list-group-item"><i class="fa fa-chart-bar mr-1"></i> Jumlah Permintaan Barang : <?=$semua?> </li>
                            </ul>
