    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form
                        action="<?= base_url('/admin/add_data') ?> "
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group ">
                                    ...
                                    <input name="kode_barang" type="text"
                                        ...
                                        id="input-kode_barang" placeholder="Kode Barang"
                                ...
                                <div class="form-group ">
                                    ...
                                    <input name="satuan_barang" type="text"
                                        class="form-control form-control-user <?= ($validation->hasError('satuan_barang')) ? 'is-invalid' : ''; ?>"
                                        id="input-satuan_barang" placeholder="Masukkan Satuan Barang"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input name="tipe" type="text"
                                        class="form-control form-control-user <?= ($validation->hasError('tipe')) ? 'is-invalid' : ''; ?>"
                                        id="input-tipe" placeholder="Masukkan Tipe Barang"
                                        value="<?= old('tipe'); ?>" />
                                    <div id="tipeFeedback" class="invalid-feedback">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input name="jumlah_barang" type="number"
                                        class="form-control form-control-user <?= ($validation->hasError('jumlah_barang')) ? 'is-invalid' : ''; ?>"
                                        id="input-jumlah_barang" placeholder="Masukkan Jumlah Barang"
                                ...
                                <div class="form-group ">
                                    ...
                                    <input name="kondisi" type="text"
                                        ...
                                        id="input-kondisi" placeholder="Masukkan Kondisi Barang"
                                        value="<?= old('kondisi'); ?>" />
