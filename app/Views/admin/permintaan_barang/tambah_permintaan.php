    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="<?= base_url('/admin/simpanPermin') ?> " method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="perihal">Perihal</label>
                                    <input type="text" name="perihal" id="perihal" class="form-control  <?= $validation->hasError('perihal') ? 'is-invalid' : ''; ?>" value="<?= old('perihal'); ?>" autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="detail" id="detail" cols="30" rows="13" class="form-control <?= $validation->hasError('detail') ? 'is-invalid' : ''; ?>"><?= old('detail'); ?></textarea>
                                    <div class="invalid-feedback">
