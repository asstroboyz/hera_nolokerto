    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form
                        action="<?= base_url('/user/simpanPengadaan') ?> "
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input name="spesifikasi" type="text"
                                        ...
                                        id="input-spesifikasi" placeholder="Nama Barang"
                                ...
                                <div class="form-group ">
                                    ...
                                    <input name="jumlah" type="number"
                                        ...
                                        id="input-jumlah" placeholder="jumlah"
                                        value="<?= old('jumlah'); ?>" />
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alasan_pengadaan" id="alasan_pengadaan" cols="30" rows="13"
                                        class="form-control <?= $validation->hasError('alasan_pengadaan') ? 'is-invalid' : ''; ?>"><?= old('alasan_pengadaan'); ?></textarea>
