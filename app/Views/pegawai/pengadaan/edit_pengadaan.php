    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="<?= base_url('/user/updatePengadaan/' . $pengadaan['id']) ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="nama_pengaju">Nama Pengaju pengadaan Barang</label>
                                    <div class="form-check">
                                        <input class="form-check-input anonym" type="radio" name="nama_pengaju" id="nama_pengaju1" value="anonym" <?= $pengadaan['nama_pengaju'] == 'anonym' ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="nama_pengaju1">
                                            <span class="text-gray-800">Samarkan (anonym)</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="nama_pengaju" id="nama_pengaju2" value="<?= user()->username; ?>" <?= $pengadaan['nama_pengaju'] != 'anonym' ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="nama_pengaju2">
                                            <span class="text-gray-800">Gunakan nama sendiri</span>
                                        </label>
                                    </div>
                                    <input type="text" class="form-control nama_pengaju" name="nama_pengaju" value="<?= $pengadaan['nama_pengaju'] ?? ''; ?>" readonly>
                                </div>
                                <div class="form-group">
